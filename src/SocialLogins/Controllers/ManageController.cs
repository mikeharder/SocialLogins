...
using SocialLogins.Models.ManageViewModels;
using SocialLogins.Services;
using System.Linq;
...
namespace SocialLogins.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index(ManageMessageId? message = null)
        {
            ...
            var testRole1 = await _roleManager.FindByNameAsync("TestRole1");
            if (testRole1 == null)
            {
            ...
            var testRole2 = await _roleManager.FindByNameAsync("TestRole2");
            if (testRole2 == null)
            {
